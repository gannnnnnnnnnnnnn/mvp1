...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("/api/dev/transfers/collisions failed", err);
    return errorJson(500, "IO_FAIL", "Failed to build transfer collisions payload.");
  }
}
